...
public class Main {
    public static void main(String[] args) {
        ...
        ((Person) nodes.get(7)).addRelationship(nodes.get(6), "employer");
        ((Company) nodes.get(6)).addRelationship(nodes.get(7), "employee");
